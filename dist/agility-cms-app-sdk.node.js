...
var autoSyncFieldHeight = function autoSyncFieldHeight(_ref3) {var containerRef = _ref3.containerRef,messageID = _ref3.messageID;
  ...
  setInterval(function () {
    var currentHeight = containerRef.current ? containerRef.current.offsetHeight : containerRef.offsetHeight;
...
const package_namespaceObject = {"i8":"0.9.5"};
...
var setAppConfig = function setAppConfig(appConfig) {
  //pass the sdk version to the CMS when setting the app config
  appConfig.__sdkVersion = package_namespaceObject.i8;
