...
The `fieldSDK` represents the object returned from `agilityAppSDK.initializeFlyout` and the base SDK to use for interacting with flyouts.
***
...
The label of the custom field that initiated the flyout.
***
`configValues <object>`
